...
public class Artist {
	...
	private void set_clut() {
		...
		clut[SEA_UNLIT] = new Color(0.000F, (float) ((ambient + (vfract / (1.0 + vfract))) * 0.500),
	...
	synchronized public void plot_column() {
		...
		if (draw_map) {
			...
			for (j = 0; j < graph_height; j++) {
				 ...
				 * SKY value. This allows us to use a testured sky for B/W
				 * displays
				 */
				if (l[j] != SKY) {
